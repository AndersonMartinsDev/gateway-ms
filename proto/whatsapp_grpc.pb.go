...
const (
	WhatsappService_GenerateQRCode_FullMethodName = "/whatsapp.WhatsappService/GenerateQRCode"
)
...
func (c *whatsappServiceClient) GenerateQRCode(ctx context.Context, in *GenerateQRCodeRequest, opts ...grpc.CallOption) (*GenerateQRCodeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateQRCodeResponse)
	err := c.cc.Invoke(ctx, WhatsappService_GenerateQRCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWhatsappServiceServer) GenerateQRCode(context.Context, *GenerateQRCodeRequest) (*GenerateQRCodeResponse, error) {
...
func _WhatsappService_GenerateQRCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateQRCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WhatsappServiceServer).GenerateQRCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WhatsappService_GenerateQRCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WhatsappServiceServer).GenerateQRCode(ctx, req.(*GenerateQRCodeRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _WhatsappService_GenerateQRCode_Handler,
		},
	},
